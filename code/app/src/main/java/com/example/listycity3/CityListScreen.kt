...
fun CityRow(
    ...
    Column(
        ...
        //Clickable row showing all cities & their province
        Row(
            modifier = Modifier
                .fillMaxWidth()
        ...
        //If row was clicked on, display edit settings
        if (showEditButton) {
            Column(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                //Button to edit current selected city
                Button(
                    onClick = {
...
fun CityListScreenPreview() {
    ListyCity3Theme {
        CityListScreen(
            ...
            //Added function parameters so this doesn't freak out
            onAddCity = {city ->},
